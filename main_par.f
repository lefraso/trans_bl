...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &            wz1(ptsx,jmax,kfour)
      ...
      call init(dv1x, dv2x, dv1y, dv2y, dv1z, dv2z, wx1, wy1, wz1, dt2,
     &          dt6, t0)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine init(dv1x, dv2x, dv1y, dv2y, dv1z, dv2z, wx1, wy1, wz1,
     &                dt2, dt6, t0)
      ...
      character*11 nome
      integer i, j, k, t0
      real*8 dt2, dt6, a(imax,5), luf(imax,5), bdfc(imax), ep,
     ...
     &  'Error! Binary files are incompatible with stf/FS parameters.'
      ...
      do i = 1, i0
        ...
        bdfc(i) = ( ( 6.d0 * ep - 15.d0 ) * ep + 10.d0 ) * ep**3
      end do
      do i = i0, i3
        bdfc(i) = 1.d0
      end do
...
c       bdfc(i) = 1.d0 + ( ( - 6.d0*ep + 15.d0 )*ep - 10.d0 )*ep**3
        bdfc(i) = ( 1.d0 - ep**50 )**4 * dexp(- ep**4 / 10.d0)
      end do
      do i = i4, imax
        bdfc(i) = 0.d0
      end do
